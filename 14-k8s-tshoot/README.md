...
- Вторая ошибка `unknown host auth-db` была получена при запросе лога работы пода в приложении web-consumer, связана с тем, что разрешенние коротких имен в разных namespace-ах не предусмотрено, необходимо
