...
## Задание 8.
 - Эти значения переменной из файла terraform.tfvars удалось передать переменной только при следующем задании переменной:
  ```
    variable "test" {
...
- При таком задании переменной получить требуемое значение в консоли можно с помощью кода
  `var.test[0].dev1[0]`
## Задание 9.
Финальный код находится в репозитории, ссылка в начале данного документа.
