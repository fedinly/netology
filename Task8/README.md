...
- Ошибка `code = FailedPrecondition desc = Platform "standart-v4" not found` говорит о том, что данная версия platform-id не поддерживается, необходимо задать v3 [link](https://yandex.cloud/ru/docs/compute/concepts/vm-platforms).
