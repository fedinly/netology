...
В итоге также был создан пользователь с требуемым методом аутентификации, при инициализации БД, [Ссылка на мануал](https://github.com/mrmoghadasi/mysql-MySQL-Docker-Setup-with-Multiple-Users/tree/main).
## Задача 6. 
