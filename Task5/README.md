...
## Задача 5.
- [Скриншот выполнения команды - одноразовый бэкап БД](Ex5/screen-09.JPG). При этом в `comnpose.yaml` файле прописана инструкция в секции `db`: `command: --mysql-native-password=ON` 
## Задача 6.  
