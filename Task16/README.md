...
## Основная часть.
 ...
 - Реализовал в версии роли 2.0.0 поддержку разных платформ, в т.ч. Debian, RedHat-подобные дистрибутивы, протестировал с помощью molecule на rocky, ubuntu 22.04. Ошибка проверки идемпотентности. При двойном запуске `molecuke converge` ошибки не возникает.  
