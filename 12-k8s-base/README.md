...
- Создан Pod с именем netology-web и сервис echoserver. Содержимое файла манифеста:
  <img src="/docs/images/T25-k8s-02/Screen-109.png" alt="Скриншот yaml 2" width="370" height="370">
- Вывод команды `curl localhost:8080`:
- <img src="/docs/images/T25-k8s-02/Screen-110.png" alt="Скриншот curl 2" width="370" height="370">
- Вывод команды (список Services):  
  <img src="/docs/images/T25-k8s-02/Screen-111.png" alt="Скриншот curl" width="370" height="170">
