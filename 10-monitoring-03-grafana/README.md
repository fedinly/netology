...
3) `(node_load15 / on(instance) group_left count(node_cpu_seconds_total{mode="idle"}) by (instance)) * 100`
...
4) `node_memory_MemAvailable_bytes / 1024 /1024 /1024` - своб.память в Гб;
   
5) `node_filesystem_free_bytes / 1024 / 1024 / 1024`.
